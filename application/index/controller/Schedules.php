...
//           ->join('erp2_teachers d ','d.t_id=a.t_id')
    ...
    public function get_tea_schedules()
    {
        ...
        $data = Schedule::where($map)->alias('a')
            ...
            ->field('sc_id,a.order,a.cost,b.t_name,a.stu_id,cur_time,d.cur_id,d.cur_name,d.tmethods,end_time,a.room_id,e.room_name,a.day,a.status,a.leave_status,a.buy_id')
